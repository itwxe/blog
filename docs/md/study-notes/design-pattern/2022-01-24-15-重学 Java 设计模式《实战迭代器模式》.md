...
![迭代器模式，图片来自 refactoringguru.cn](https://images.itwxe.com/images/2022/01/cb4eb37c0289d.png)
...
![场景模拟；公司树形组织架构](https://images.itwxe.com/images/2022/01/15f9ef60b4ad9.png)
...
![迭代器模式模型结构](https://images.itwxe.com/images/2022/01/bdf50673532cc.png)
