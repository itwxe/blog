---
title: Generator
permalink: '/web-notes/03-javascript/es6/485ff9d3.html'
date: 2024-06-12
author: 阮一峰
---
...
Generator 函数是 ES6 提供的一种异步编程解决方案，语法行为与传统函数完全不同。本章详细介绍 Generator 函数的语法和 API，它的异步编程应用请看 [Generator 函数的异步应用](17.Generator 异步应用) 一章。
