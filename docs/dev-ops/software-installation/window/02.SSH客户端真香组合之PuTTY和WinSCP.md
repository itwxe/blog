...
![配置基础](https://itwxe.com/img/blog/166463773302771.png)
...
![窗口设置](https://itwxe.com/img/blog/166463773314019.png)

2、Window -> Appearance

Font setting -> Change 调整字体。

![字体设置](https://itwxe.com/img/blog/166463773324829.png)

3、Connection -> keepalives: 60

长时间不操作断开连接，设置 keepalive 保持连接，比如设置为60秒发送一个空数据包保持连接。

![keepalive](https://itwxe.com/img/blog/166463773346483.png)

4、Connection -> Data

Auto-login username 可填写登录用户名。省去每次需要填写Username的麻烦。

![默认用户名](https://itwxe.com/img/blog/166463773357437.png)
...
![配色效果图](https://itwxe.com/img/blog/166463773365923.png)
...
![密钥开始生成](https://itwxe.com/img/blog/166463773383392.png)

![密钥生成中](https://itwxe.com/img/blog/166463773398032.png)

2、密钥生成后保存复制公钥及保存私钥。

![密钥生成完成](https://itwxe.com/img/blog/166463773400816.png)
...
![选择私钥](https://itwxe.com/img/blog/166463773406816.png)

**最关键的一步**，一定不要忘了保存，特别是如果没有显示 HostName 和 Saved Sessions 一定要点击 load，再点击保存，不然设置不生效。

![保存设置](https://itwxe.com/img/blog/166463773406688.png)
...
![WinSCP](https://itwxe.com/img/blog/166463773408375.png)

拖拽即可上传，这是单栏模式，也可以设置成类似 xftp 的双栏模式。

![单栏WinSCP](https://itwxe.com/img/blog/166463773417290.png)