  ...
  <aside class="page-sidebar">
    ...
    <div class="page-side-toolbar">
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img src="/images/system/phone.png" class="nozoom" />
        ...
        <div class="toc-container">
            <div class="pos-box">
              ...
              <div class="scroll-box" style="text-align:center" >
                ...
                <img v-bind="{src: 'https://api.qrserver.com/v1/create-qr-code/?data=https://www.itwxe.com/posts/'+this.$route.fullPath }" height="180px" style="margin:10px;"/>
...
<!--      </div>-->
      ...
      <div class="option-box" v-on:mouseover="showToc($event)" v-on:mouseout="hideToc($event)">
        <img class="nozoom" src="/images/system/weixin.png" width="25px" />
        <span class="show-txt">公众号</span>
        <div class="toc-container">
            <div class="pos-box">
              <div class="icon-arrow"></div>
              <div class="scroll-box" style="text-align:center" >
...
<!--            <h4>站点导航图-->
<!--              <router-link class="sitemap-top-link" key="/md/about/me.html" to="/md/about/me.html" > 关于我</router-link>-->
<!--            </h4>-->
<!--            <SiteMap />-->
<!--        </div>-->
<!--      </div>-->
